...
public class ShutdownTests : IAsyncLifetime
{
    ...
    {
        // UseDevelopmentEmulator=true instructs the Azure SDK to skip TLS certificate
        // validation, which allows the test to connect using the untrusted dev cert
        // generated by the test host fixture.
